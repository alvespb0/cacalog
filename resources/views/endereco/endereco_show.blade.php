...
<style>
    ...
    <div class="card shadow p-4 mb-4 bg-white rounded">
        <h1 class="mb-4 text-center" style="color: #1c2e4b;">Endereços</h1>

        <table class="table table-hover table-bordered text-center align-middle" style="border-radius: 10px; overflow: hidden;">
            <thead class="table-dark">
                <tr>
                    <th style ="background: #1c2e4b;">Logradouro</th>
                    <th style ="background: #1c2e4b;">Numero</th>
            ...
            @foreach($enderecos as $endereco)
                <tr>
                    ...
                    <td>
                            ...
                            <a href="{{ route('excluir.endereco', ['id' => $endereco->id])}}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir?')">
